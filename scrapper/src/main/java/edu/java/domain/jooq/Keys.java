...
public class Keys {
    ...
    public static final UniqueKey<LinkageRecord> CONSTRAINT_3559 = Internal.createUniqueKey(Linkage.LINKAGE,
        DSL.name("CONSTRAINT_3559"),
        new TableField[] {Linkage.LINKAGE.CHAT_ID, Linkage.LINKAGE.LINK_ID},
        true
    );
    ...
    public static final ForeignKey<GithubBranchesRecord, LinksRecord> CONSTRAINT_5 = Internal.createForeignKey(
        GithubBranches.GITHUB_BRANCHES,
        DSL.name("CONSTRAINT_5"),
        new TableField[] {GithubBranches.GITHUB_BRANCHES.LINK_ID},
        Keys.CONSTRAINT_4,
        new TableField[] {Links.LINKS.ID},
        true
    );
    public static final ForeignKey<LinkageRecord, ChatsRecord> CONSTRAINT_35 =
        Internal.createForeignKey(Linkage.LINKAGE,
            DSL.name("CONSTRAINT_35"),
            new TableField[] {Linkage.LINKAGE.CHAT_ID},
            Keys.CONSTRAINT_3,
            new TableField[] {Chats.CHATS.ID},
            true
        );
    public static final ForeignKey<LinkageRecord, LinksRecord> CONSTRAINT_355 =
        Internal.createForeignKey(Linkage.LINKAGE,
            DSL.name("CONSTRAINT_355"),
            new TableField[] {Linkage.LINKAGE.LINK_ID},
            Keys.CONSTRAINT_4,
            new TableField[] {Links.LINKS.ID},
            true
        );
    public static final ForeignKey<StackoverflowQuestionRecord, LinksRecord> CONSTRAINT_9 = Internal.createForeignKey(
        StackoverflowQuestion.STACKOVERFLOW_QUESTION,
        DSL.name("CONSTRAINT_9"),
        new TableField[] {StackoverflowQuestion.STACKOVERFLOW_QUESTION.LINK_ID},
        Keys.CONSTRAINT_4,
        new TableField[] {Links.LINKS.ID},
        true
    );
