...
public class Links extends TableImpl<LinksRecord> {
     ...
     */
    public final TableField<LinksRecord, OffsetDateTime> LAST_UPDATED_AT =
        createField(DSL.name("LAST_UPDATED_AT"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "");
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function3<? super Long, ? super String, ? super OffsetDateTime, ? extends U> from
    ) {
