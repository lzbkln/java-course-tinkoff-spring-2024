...
import static edu.java.configuration.retry.RetryType.CONSTANT;
...
public class ConstantRetryTest {
    ...
    @Test
    @DisplayName("Test that constant retry works correct for client error")
    void testThatConstantRetryWorksCorrectForClientError() {
